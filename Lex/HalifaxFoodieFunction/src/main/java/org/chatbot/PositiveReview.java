...
public class PositiveReview  implements RequestHandler<Map<String, Object>, Map<String, Object>> {
  ...
  public Map<String, Object> handleRequest(Map<String, Object> event, Context context) {
    ...
    try {
      UpdateItemSpec updateItemSpec = new UpdateItemSpec().withPrimaryKey("OrderID", orderNumber)
          .withUpdateExpression("set OrderReview = :r").withValueMap(new ValueMap().withString(":r", "Satisfied"))
    ...
    content.put("content", "We have updated the review and really thrilled " +
        "to hear such response. Thanks for choosing HalifaxFoodie.");
